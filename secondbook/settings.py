...
# Django settings for secondbook project.
...
SECRET_KEY = '3u1_!83xile6ukzq8h%_5efsvfdqh5xq9173tzz+8t9_2q)uqv'
...
ROOT_URLCONF = 'secondbook.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'secondbook.wsgi.application'
